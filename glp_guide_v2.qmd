...
# Finding a Place to Live {#finding-a-place-to-live}
...
::: {.panel-tabset}
## **Neighborhoods** {#neighborhood-options}
...
### Local Options
Add description for options that are closer to the options
...
## **Apartment Search** {#finding-an-apartment}
...
::: {.section-dark}
# Getting Around Dallas {#parking-and-transportation}
...
## **Public Transit and TollTag** {#dart-tolltag}
...
Add section description for future use for GLPs
